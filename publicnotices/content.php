...
Modifications:
	22Sept14 zig
		- only display Date at time of article (not author)
		- dont display posted in categetoryes in article footer.
*/
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header text-center">
		...
		<div class="entry-meta">
			<?php/* zig flatsome_posted_on();  only want publish date*/ ?>
				<time class="entry-date" datetime="<?php ?>"><?php  echo esc_html( get_the_date() ) ?></time>
		</div><!-- .entry-meta -->
		<?php endif; ?>
	</header><!-- .entry-header -->
