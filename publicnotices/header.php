...
modifications
	22Sept2014 zig
		dont print message about define your main nav....
	26Sept2014 zig
		add image after right lights for 'public notices'
*/
?>
<!DOCTYPE html>
	...
	<div id="wrapper">
			...
			<div class="row">
				<div class="large-12 columns">
					...
					<div class="right-text right">
						...
						?>
						 <?php else: ?>
                            <?php /*  Define your top bar navigation in <b>Apperance > Menus</b> */ ?>
                        <?php endif; ?>
					</div><!-- .pos-text -->
		...
		<header id="masthead" class="site-header" role="banner">
					...
					<div class="left-links">
						<?php if(!isset($flatsome_opt['nav_position']) || $flatsome_opt['nav_position'] == 'top'){ ?>
							<ul id="site-navigation" class="header-nav">
		                        ...
		                        <?php else: ?>
		                            <?php /* commented out by zig <li>Define your main navigation in <b>Apperance > Menus</b></li> */ ?>
		                        <?php endif; ?>
							</ul>
						<?php } else { ?>
			...
			<div id="site-byline-image">
				<img class="header-left" src="<?php echo get_stylesheet_directory_uri() ?>/images/identifier.png">
			</div>
		</div><!-- .large-12 -->
	</div><!-- .row -->
...
<div class="wide-nav <?php echo $flatsome_opt['nav_position_color']; ?> <?php if($flatsome_opt['nav_position'] == 'bottom_center') {echo 'nav-center';} else {echo 'nav-left';} ?>">
	<div class="row">
		...
		<ul id="site-navigation" class="header-nav">
				...
				<?php } ?>
              <?php else: ?>
                   <li>/<?php /* Define your main navigation in <b>Apperance > Menus</b>*/ ?></li>
              <?php endif; ?>
		</ul>
